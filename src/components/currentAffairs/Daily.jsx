      ...
      <div>
        ...
        <div className="flex lg:flex-row flex-col-reverse md:flex-row lg:p-10 md:p-6 p-4 justify-between gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 w-full">
            {isLoading ? (
              ...
              currentAffairs.map((data, index) => (
                ...
                >
                  {/* Card Title */}
                  <h2 className="textPurple font-bold mb-4">
          ...
          <div className="relative flex flex-col mx-auto mt-6 items-center w-[30%]">
            <button
              className="font-semibold px-8 py-3 border-2 border-[#543a5d] bgGredient-purple text-white rounded-md shadow-lg hover:from-[#935aa6] hover:to-[#543a5d] transition-all duration-300 ease-in-out"
