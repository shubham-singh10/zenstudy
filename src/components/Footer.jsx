        ...
        <div className="w-full lg:w-1/2 mt-4 flex flex-wrap">
          ...
          <div className="w-full md:w-1/2 flex flex-col lg:items-start md:items-start md:px-14  items-start">
            ...
            <div className="flex items-start space-x-4">
              ...
              <Link to="https://wa.me/919810246095" target="blank" className="flex justify-end bg-green-500  hover:bg-green-700 p-2 text-white z-50 rounded-full fixed bottom-0 right-5 mb-6 text-4xl animate-bounce ...">
                <div >
                  <FaWhatsapp />
                </div>
              </Link>
