                ...
                <div className="overflow-hidden rounded-xl bg-white shadow">
                    ...
                    <div className="px-6 py-8 sm:px-8">
                        <div className="space-y-8">
                            ...
                            <section>
                                <div className="flex items-center gap-3 mb-4">
                                    <PiUserCircle className="h-6 w-6 text-indigo-600" />
                            ...
                            <section>
                                <div className="flex items-center gap-3 mb-4">
                                    <BiBookOpen className="h-6 w-6 text-indigo-600" />
                            ...
                            <section>
                                <div className="flex items-center gap-3 mb-4">
                                    <BiCreditCard className="h-6 w-6 text-indigo-600" />
                            ...
                            {[
                                {
                                    ...
                                    icon: <FiAlertCircle className="h-6 w-6 text-indigo-600" />,
                                ...
                                },
                                {
                                    ...
                                    icon: <LuScrollText className="h-6 w-6 text-indigo-600" />,
                            ...
                            <section className="rounded-lg bg-indigo-50 p-6">
                                ...
                                <div className="flex items-center gap-3">
                                    <a href="mailto:contact@zenstudy.in" className="text-indigo-600 hover:underline">
                                        contact@zenstudy.in
                                    </a>
                                </div>
                            </section>
