    ...
    >
      <div className="relative h-48 md:h-64">
        ...
        <div className="absolute  bottom-0 left-0 right-0 p-6 text-white">
          ...
          <p className="text-gray-200 truncate">{test.shortDescription}</p>
        </div>
        {test.includedInCourse && (
          <div className="absolute top-0 right-0 p-2 bg-gradient-to-r from-black/100 to-transparent text-white rounded-bl-xl">
