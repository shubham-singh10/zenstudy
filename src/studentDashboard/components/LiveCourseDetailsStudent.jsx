...
import CoursePageSkeleton from "../../components/course/course-detailslive-skeleton";
  ...
  return (
    <Fragment>
      ...
      >
        ...
        {/* Main Content */}
        <div className="flex flex-col-reverse lg:flex-row w-full lg:mx-0">
          {/* Left Section */}
...
export default LiveCourseDetailStudent;
